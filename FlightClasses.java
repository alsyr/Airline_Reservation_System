...
/**
 * Creates the first and economy classes
 * and keeps track of all passengers
 */
public class FlightClasses
{
    ...
    /**
     * Construct both classes as arrays of Rows objects.
     * Initialize also the number of empty seats in 
     ...
     * @param numRow an int representing the number of rows in the class
     * @param numSeat an int representing the number of seats in one row
     * @param gap an int representing 1 or 10 for the sake of printing understandable seat letter
     */     
     ...
     * @return numEmptySeat an int representing the number of empty seats in the row
     */    
    private int addSubGroup(String group, Rows[] theClass, ArrayList<String> names, int numRow, int numSeat, int gap, int numEmptySeat)
    {
